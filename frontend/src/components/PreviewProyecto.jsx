...
function PreviewProyecto({ proyecto }) {
  const { auth } = useAuth()
  const { nombre, _id, cliente, fechaEntrega, creador } = proyecto
  return (
    <div className='border-b p-5 flex flex-col md:flex-row justify-between items-center gap-3 md:gap-0'>
